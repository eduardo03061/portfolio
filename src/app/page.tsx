          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              <p className="text-lg">
                ...
                building modern web applications. I specialize in both frontend
                and backend development, creating seamless user experiences with
                clean, efficient code.
              </p>
              <p className="text-lg">
                With several years of experience in the industry, I&apos;ve
                worked on a variety of projects from e-commerce platforms to
                complex web applications. I&apos;m constantly learning and
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <p className="text-lg">
                ...
                opportunities. If you have a project that needs my expertise or
                if you want to discuss potential collaborations, feel free to
                reach out!
              </p>
              <div className="flex items-center gap-2">
                <Mail className="h-5 w-5" />
                <a
                  href="mailto:eduardoalejandrohg@gmail.com"
            ...
            <div className="space-y-4">
              <p className="text-lg">
                If you want to talk to me, you can send me a message through
                WhatsApp.
              </p>
              <div className="flex items-center gap-2">
                <Mail className="h-5 w-5" />
                <a
                  href="https://wa.me/523121978224"
                  className="text-primary hover:underline"
                >
                  Send a message
                </a>
